...
public class Main {
	...
	public static void main(String[] args) {
		...
		Maneger manager = new Maneger(0, null, null, null, null, null, null);
		...
		do {
			...
			case 17:
		        ...
		        manager = new Maneger(id_mg, namemanager, function, email, senha, telephone, department);
			...
			case 18:
				if(member.validateMember()==true) {
					System.out.println("Digite o Id para remocao:");
					int id_remove = sc.nextInt();
					manager.removeMeneger(id_remove);
				}
			break;
